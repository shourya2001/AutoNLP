import pandas as pd
from transformers import XLNetTokenizerFast, AutoModelForSequenceClassification, TrainingArguments, Trainer
...
if __name__ == "__main__":
    ...
    xlnet = XLNET(path, parameters)
    score, time = xlnet.pipeline()
